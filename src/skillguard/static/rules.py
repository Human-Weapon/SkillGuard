...
SG_PY_001 = _register(
    "SG-PY-001", "subprocess call with shell=True", "process",
...
SG_PY_008 = _register(
    "SG-PY-008", "pickle deserialization", "dynamic_code",
...
SG_PY_017 = _register(
    "SG-PY-017", "Python source could not be parsed", "analysis",
    Severity.INFO, Confidence.HIGH,
...
SG_SECRET_001 = _register(
    "SG-SECRET-001", "private key block", "secrets",
...
SG_SECRET_002 = _register(
    "SG-SECRET-002", "well-known credential token prefix", "secrets",
    Severity.HIGH, Confidence.HIGH,
...
SG_SECRET_003 = _register(
    "SG-SECRET-003", "credential-like assignment", "secrets",
...
SG_SECRET_004 = _register(
    "SG-SECRET-004", "high-entropy string literal", "secrets",
...
SG_MANIFEST_001 = _register(
    "SG-MANIFEST-001", "direct URL dependency", "supply_chain",
    Severity.MEDIUM, Confidence.HIGH,
...
SG_MANIFEST_005 = _register(
    "SG-MANIFEST-005", "npm install lifecycle script", "supply_chain",
    Severity.MEDIUM, Confidence.HIGH,
...
SG_MANIFEST_006 = _register(
    "SG-MANIFEST-006", "manifest could not be parsed", "analysis",
    Severity.INFO, Confidence.HIGH,
    "The manifest file could not be parsed. Manifest-derived analysis for this file is "
    "incomplete.",
)
...
SG_PATH_001 = _register(
    "SG-PATH-001", "symlink or reparse point in scan target", "filesystem",
    Severity.INFO, Confidence.HIGH,
